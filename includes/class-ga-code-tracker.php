...
class Ga_Code_Tracker {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Ga_Code_Tracker_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-ga-code-tracker-public.php';

		$this->loader = new Ga_Code_Tracker_Loader();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Ga_Code_Tracker_Loader    Orchestrates the hooks of the plugin.
	 */
